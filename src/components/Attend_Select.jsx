      ...
      <Baseselect>
        ...
        <Dropdown style={{display: dropdownVisible ? 'flex' : 'none'}}>
          <Content>
            <Sessg>
              <Bdlss>
                <Bdli1 onClick={() => {setLabel('반차'), toggleDropdown(), props.setSelectedLabel('반차')}} >
                  <Content2>
                    <Label>반차</Label>
                    <Options>
                      <Check></Check>
              ...
              <Bdlss>
                <Bdli2 onClick={() => {setLabel('연차'), toggleDropdown(), props.setSelectedLabel('연차')}}>
                  <Content2>
                    <Label>연차</Label>
                    <Options>
                      <Check2></Check2>
